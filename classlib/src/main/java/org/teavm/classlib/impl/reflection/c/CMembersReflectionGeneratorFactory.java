...
public class CMembersReflectionGeneratorFactory implements ReflectionGeneratorFactory {
    ...
    public CMembersReflectionGeneratorFactory(ReflectionDependencyListener reflection) {
        this.reflection = reflection;
    }

    @Override
    public ReflectionGenerator createReflectionGenerator(ReflectionGeneratorFactoryContext context) {
        return new CMembersReflectionGenerator(reflection);
    }
}

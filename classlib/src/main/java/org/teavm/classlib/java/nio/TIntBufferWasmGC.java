...
class TIntBufferWasmGC extends TIntBufferNative {
    TIntBufferWasmGC(Object gcRef, int[] array, int position, int limit, boolean readOnly, Object base,
    ...
    TIntBuffer duplicate(int start, int capacity, int position, int limit, boolean readOnly) {
        return new TIntBufferWasmGC(gcRef, array, position, limit, readOnly, base, address.add(start * 4),
                capacity, swap);
    }

...
final class TStringToReal {
    ...
    private static double parseDblImpl(String s, int e) {
        // TODO reimplement https://cs.android.com/android/platform/superproject/+/master:libcore/luni/src/main/native/java_lang_StringToReal.cpp;l=92;drc=master
        return (double) Long.parseLong(s) * Math.pow(10, e);
    }
    ...
    private static float parseFltImpl(String s, int e) {
        // TODO reimplement https://cs.android.com/android/platform/superproject/+/master:libcore/luni/src/main/native/java_lang_StringToReal.cpp;l=484;drc=master
        return (float) Integer.parseInt(s) * (float) Math.pow(10, e);
    }
    ...
    public static double parseDouble(String s) {
        ...
        if (s.contains("0x") || s.contains("0X")) {
            return THexStringParser.parseDouble(s);
        }
    ...
    public static float parseFloat(String s) {
        ...
        // We don't use startsWith because there might be a leading sign.
        if (s.contains("0x") || s.contains("0X")) {
            return THexStringParser.parseFloat(s);
        }

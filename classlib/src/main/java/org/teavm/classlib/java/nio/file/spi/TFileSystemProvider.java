...
public abstract class TFileSystemProvider {
    ...
    public TInputStream newInputStream(TPath path, TOpenOption... options) throws IOException {
        throw new UnsupportedOperationException();
    }

    public TOutputStream newOutputStream(TPath path, TOpenOption... options) throws IOException {
        throw new UnsupportedOperationException();
    }
    ...
    public boolean exists(TPath path, TLinkOption... options) throws IOException {
        try {

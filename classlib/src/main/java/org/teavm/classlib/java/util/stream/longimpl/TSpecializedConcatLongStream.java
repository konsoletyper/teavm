...
public class TSpecializedConcatLongStream extends TSimpleLongStreamImpl {
    TSimpleLongStreamImpl first;
    TSimpleLongStreamImpl second;
    TSimpleLongStreamImpl current;

    public TSpecializedConcatLongStream(TSimpleLongStreamImpl first, TSimpleLongStreamImpl second) {
        this.first = first;
        this.second = second;
        current = first;
    }

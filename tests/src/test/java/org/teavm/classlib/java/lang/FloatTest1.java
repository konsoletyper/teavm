...
public class FloatTest1 {
    ...
    public void test_byteValue() {
        ...
        Float f = Float.valueOf(0.46874f);
        Float f2 = Float.valueOf(90.8f);
    ...
    public void test_compare() {
        ...
        try {
            Float.valueOf(0.0F).compareTo(null);
            fail("No NPE");
    ...
    public void test_doubleValue() {
        ...
        assertTrue("Incorrect double value returned", Math.abs(Float.valueOf(999999.999f)
    ...
    public void test_floatValue() {
        ...
        Float f = Float.valueOf(87.657f);
        Float f2 = Float.valueOf(-0.876f);
    ...
    public void test_isInfinite() {
        ...
        assertTrue("Infinity check failed",
                (Float.valueOf(Float.POSITIVE_INFINITY).isInfinite() && Float.valueOf(
                        Float.NEGATIVE_INFINITY).isInfinite())
                        && !(Float.valueOf(0.13131414f).isInfinite()));
    }
    /**
    ...
    public void test_isNaN() {
        ...
        assertTrue("NAN check failed", Float.valueOf(Float.NaN).isNaN()
                && !(Float.valueOf(1.0f).isNaN()));
    }
    /**
    ...
    public void test_parseFloat_LString_Harmony6261() {
        ...
        float f = Float.valueOf("2147483648");
    ...
    public void test_valueOfLjava_lang_String() {
        ...
        Float expectedNaN = Float.valueOf(Float.NaN);
        ...
        assertTrue("Floattest5", posInfinite.equals(Float.valueOf(Float.POSITIVE_INFINITY)));
        Float posInfiniteSigned = Float.valueOf("+Infinity");
        assertTrue("Floattest6", posInfiniteSigned.equals(Float.valueOf(Float.POSITIVE_INFINITY)));
        Float negInfiniteSigned = Float.valueOf("-Infinity");
        assertTrue("Floattest7", negInfiniteSigned.equals(Float.valueOf(Float.NEGATIVE_INFINITY)));
        // test HARMONY-6641
        posInfinite = Float.valueOf("320.0E+2147483647");
        assertEquals("Floattest8", Float.valueOf(Float.POSITIVE_INFINITY), posInfinite);
        negZero = Float.valueOf("-1.4E-2147483314");
        assertEquals("Floattest9", Float.valueOf(-0.0f), negZero);
    }
    ...
    public void test_compareToLjava_lang_Float() {
        ...
        for (int i = 0; i < values.length; i++) {
            ...
            Float objFloat = Float.valueOf(f1);
    ...
    public void test_equalsLjava_lang_Object() {
        Float f1 = Float.valueOf(8765.4321f);
        Float f2 = Float.valueOf(8765.4321f);
        ...
        assertTrue("Assert 2: NaN should not be == Nan", Float.valueOf(Float.NaN).equals(Float.valueOf(
                Float.NaN)));
        assertTrue("Assert 3: -0f should be == 0f", 0f == -0f);
        assertTrue("Assert 4: -0f should not be equals() 0f", !Float.valueOf(0f).equals(Float.valueOf(
                -0f)));
        f1 = Float.valueOf(1098.576f);
        f2 = Float.valueOf(1098.576f);
        ...
        assertTrue("NaN should not be == Nan", Float.valueOf(Float.NaN)
                .equals(Float.valueOf(Float.NaN)));
        assertTrue("-0f should be == 0f", 0f == -0f);
        assertTrue("-0f should not be equals() 0f", !Float.valueOf(0f).equals(Float.valueOf(-0f)));
    }
    /**
    ...
    public void test_valueOfF() {
        assertEquals(Float.valueOf(Float.MIN_VALUE), Float.valueOf(Float.MIN_VALUE));
        assertEquals(Float.valueOf(Float.MAX_VALUE), Float.valueOf(Float.MAX_VALUE));
        assertEquals(Float.valueOf(0), Float.valueOf(0));
        int s = -128;
        while (s < 128) {
            assertEquals(Float.valueOf(s), Float.valueOf(s));

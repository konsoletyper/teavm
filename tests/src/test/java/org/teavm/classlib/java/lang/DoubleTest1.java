...
public class DoubleTest1 {
    ...
    private void doTestCompareRawBits(String originalDoubleString, long expectedRawBits,
        ...
        convertedString = Double.valueOf(result).toString();
    ...
    public void test_ConstructorD() {
        Double d = Double.valueOf(39089.88888888888888888888888888888888);
    ...
    public void test_ConstructorLjava_lang_String() {
        ...
        try {
            d = Double.valueOf("1E+-20");
            fail("Double.valueOf(\"1E+-20\") should throw exception");
    ...
    public void test_byteValue() {
        Double d = Double.valueOf(1923311.47712);
    ...
    public void test_compare() {
        ...
        try {
            Double.valueOf(0.0D).compareTo(null);
            fail("No NPE");
    ...
    public void test_doubleValue() {
        assertEquals("Incorrect double value returned", 999999999999999.9999999999999,
                Double.valueOf(999999999999999.9999999999999).doubleValue(), 0D);
    }
    /**
    ...
    public void test_floatValue() {
        ...
        assertTrue(
                ...
                Math
                        .abs(Double.valueOf(999999999999999.9999999999999d).floatValue() - 999999999999999.9999999999999f) < 1);
    }
    /**
    ...
    public void test_hashCode() {
        ...
        assertEquals("Magic assumption hasCode (0.0) = 0 failed", 0, Double.valueOf(0.0).hashCode());
    }
    /**
    ...
    public void test_isInfinite() {
        ...
        assertTrue("NEGATIVE_INFINITY returned false", Double.valueOf(Double.NEGATIVE_INFINITY)
                .isInfinite());
        assertTrue("POSITIVE_INFINITY returned false", Double.valueOf(Double.POSITIVE_INFINITY)
                .isInfinite());
        assertTrue("Non infinite number returned true", !(Double.valueOf(1000).isInfinite()));
    }
    /**
...
//                0x8000000000000002L, "-1.0E-323");
    ...
    public void test_valueOfLjava_lang_String() {
        ...
        Double expectedNaN = Double.valueOf(Double.NaN);
        ...
        assertTrue("Doubletest4", posInfinite.equals(Double.valueOf(Double.POSITIVE_INFINITY)));
    ...
    public void test_compareToLjava_lang_Double() {
        ...
        for (int i = 0; i < values.length; i++) {
            ...
            Double objDouble = Double.valueOf(d1);
    ...
    public void test_equalsLjava_lang_Object() {
        Double d1 = Double.valueOf(87654321.12345d);
        Double d2 = Double.valueOf(87654321.12345d);
        Double d3 = Double.valueOf(0.0002f);
        ...
        assertTrue("Assert 3: NaN should not be == Nan", Double.valueOf(Double.NaN)
                .equals(Double.valueOf(Double.NaN)));
        assertTrue("Assert 4: -0d should be == 0d", 0d == -0d);
        assertTrue("Assert 5: -0d should not be equals() 0d", !Double.valueOf(0d)
                .equals(Double.valueOf(-0d)));
        Double dmax = Double.valueOf(Double.MAX_VALUE);
        Double dmax1 = Double.valueOf(Double.MAX_VALUE);
    ...
    public void test_valueOfD() {
        assertEquals(Double.valueOf(Double.MIN_VALUE), Double.valueOf(Double.MIN_VALUE));
        assertEquals(Double.valueOf(Double.MAX_VALUE), Double.valueOf(Double.MAX_VALUE));
        assertEquals(Double.valueOf(0), Double.valueOf(0));
        int s = -128;
        while (s < 128) {
            assertEquals(Double.valueOf(s), Double.valueOf(s));
            assertEquals(Double.valueOf(s + 0.1D), Double.valueOf(s + 0.1D));
            s++;
        }
    }
    /**

...
public class FormData implements JSObject {
    ...
    public FormData(FormData oldForm) {

    }

    public native void append(String name, String value);

    public native void append(String name, JSObject value);

    public native void append(String name, String value, String fileName);

    public native void append(String name, JSObject value, String fileName);

    public native void delete(String name);

    public native String get(String name);

    public native JSArray<?> getAll(String name);
    ...
    public native void set(String name, JSObject value, String fileName);
}

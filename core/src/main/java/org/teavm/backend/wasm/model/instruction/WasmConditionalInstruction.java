...
public class WasmConditionalInstruction extends WasmInstruction {
    ...
    private final WasmConditionalBlock thenBlock = new WasmConditionalBlock();
    private final WasmConditionalBlock elseBlock = new WasmConditionalBlock();
    ...
    public WasmConditionalBlock getThenBlock() {
        return thenBlock;
    }

    public WasmConditionalBlock getElseBlock() {
        return elseBlock;
    }

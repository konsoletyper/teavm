...
public class WasmStoreInt32Instruction extends WasmInstruction {
    private int alignment;
    private int offset;
    private WasmInt32Subtype convertTo;

    public WasmStoreInt32Instruction(int alignment, WasmInt32Subtype convertTo) {
        this.alignment = alignment;
        this.convertTo = Objects.requireNonNull(convertTo);
    }

...
public class WasmGCAnnotationsHelper {
    private ClassReaderSource classes;
    private WasmGCClassInfoProvider classInfoProvider;
    private WasmGCStringProvider stringProvider;

    public WasmGCAnnotationsHelper(ClassReaderSource classes, WasmGCClassInfoProvider classInfoProvider,
            WasmGCStringProvider stringProvider) {
        this.classes = classes;
        this.classInfoProvider = classInfoProvider;
        this.stringProvider = stringProvider;
    }

    public WasmExpression generateAnnotations(Iterable<? extends AnnotationReader> annotations) {
    ...
    public WasmExpression generateAnnotation(AnnotationReader annotation) {

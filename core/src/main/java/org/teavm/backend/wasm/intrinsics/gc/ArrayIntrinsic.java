...
public class ArrayIntrinsic implements WasmGCIntrinsic {
    ...
    private WasmExpression arrayVirtualCall(InvocationExpr invocation, WasmGCIntrinsicContext context,
        ...
        var vtRef = new WasmStructGet(objectStruct, object.expr(), WasmGCClassInfoProvider.CLASS_FIELD_OFFSET);
        ...
        call.getArguments().add(new WasmStructGet(vtStruct, vt.expr(), 0));

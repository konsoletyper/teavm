...
public class GenericArrayInfoIntrinsic implements Intrinsic {
    @Override
    public boolean canHandle(MethodReference method) {
        return method.getClassName().equals(GenericArrayInfo.class.getName());
    }
